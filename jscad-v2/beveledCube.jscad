...
const beveledCube = ({
  ...
  if (r) {
    ...
    if (R) {
      ...
      if (include.includes("bs")) bevels.push(translate([-xr, 0, zr], rotateDeg([0, -90, 90], bevel(x, R))));
      if (include.includes("bn")) bevels.push(translate([xr, 0, zr], rotateDeg([0, -90, 270], bevel(x, R))));
    }
    ...
    if (R) {
      ...
      if (include.includes("ts")) bevels.push(translate([-xr, 0, -zr], rotateDeg([0, 90, 90], bevel(x, R))));
      if (include.includes("tn")) bevels.push(translate([xr, 0, -zr], rotateDeg([0, 90, 270], bevel(x, R))));
    }
  }
